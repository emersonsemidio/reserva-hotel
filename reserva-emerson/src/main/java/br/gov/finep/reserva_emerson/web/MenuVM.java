...
public class MenuVM implements Serializable {
    ...
    public static final String NOME_APLICACAO = "reserva-emerson";
    ...
    public Boolean isURLExterna(){
	  ...
	  public static String urlTelaQuartoMVVM() { return getUrlAplicacao() +
	  URL_INTRANET + "/privado/telaQuartoMVVM.zul"; }
	 

	/*
	 * public static String urlDetalheEmpresaMVVM() { return getUrlAplicacao() +
	 * URL_INTRANET + "/privado/detalheEmpresaMVVM.zul"; }
	 */

	
	  public static String urlDetalheQuartoMVVM() { return getUrlAplicacao() +
	  URL_INTRANET + "/privado/detalheQuartoMVVM.zul"; }
	  
	  public static String urlTelaReservaMVVM() { return getUrlAplicacao() +
	  URL_INTRANET + "/privado/telaReservaMVVM.zul"; }
